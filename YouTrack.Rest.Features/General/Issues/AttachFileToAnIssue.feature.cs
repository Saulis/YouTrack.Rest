...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Attach File to an Issue")]
        public virtual void AttachFileToAnIssue()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Attach File to an Issue", ((string[])(null)));
#line 6
...
#line 8
   testRunner.When("I attach an file to the issue");
#line 9
