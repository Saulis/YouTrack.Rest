...
#line 5
 testRunner.When("I authenticate with login \"youtrack.rest\" and password \"youtrack.rest\" to \"http:/" +
                    "/localhost:80\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 6
...
this.ScenarioSetup(scenarioInfo);
#line 10
 testRunner.When("I authenticate with login \"foo\" and password \"bar\" to \"http://localhost:80\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 11
